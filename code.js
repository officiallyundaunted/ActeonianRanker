/* SETTINGS START */
const prefix = "!"
const groupID = 5143255;
const bot_token = process.env.botToken;
const rblxCookie = process.env.rblxCookie;
const officerRoleE = "Officer";
const welcomeMessage = "**Welcome to the Acteonian Communications, we pleasure you being here.**";
const maxXP = 100;
const xpAuditLogChannelID = "619719087903473677";
const mainChatChannelID = "619719087903473677";
...
bot.on('ready', () => {
  ...
  bot.channels.get(bot.channels.get(`${mainChatChannelID}`).id).send(`**The Acteonian Ranker is back online, and ready to role!**`)
})
